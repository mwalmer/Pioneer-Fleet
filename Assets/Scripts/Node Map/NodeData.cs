...
public static class NodeData
{
    ...
    public static List<string> PlanetNames = new List<string>() 
    {
        ...
        "Beemim", "Beid", "Belel", "Bélénos", "Bellatrix", "Berehynia", "Betelgeuse", "Bharani", "Bibhā", "Biham",
        ...
        "Deneb", "Deneb Algedi", "Denebola", "Diadem", "Dingolay", "Diphda", "Dìwö", "Diya", "Dofida", "Dombay",
        ...
        "Hadar", "Haedus", "Hamal", "Hassaleh", "Hatysa", "Helvetios", "Heze", "Hoggar", "Homam", "Horna", "Hunahpú",
        ...
        "Muscida", "Musica", "Muspelheim", "Nahn", "Naledi", "Naos", "Nash", "Nashira", "Násti",
