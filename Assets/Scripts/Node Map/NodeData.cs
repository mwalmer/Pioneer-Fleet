...
public static class NodeData
{
    ...
    public static List<string> PlanetNames = new List<string>() 
    {
        ...
        "Beemim", "Beid", "Belel", "Belenos", "Bellatrix", "Berehynia", "Betelgeuse", "Bharani", "Bibha", "Biham",
        ...
        "Libertas", "Lich", "Liesma", "Lilii Borea", "Lionrock", "Lucilinburhuc", "Lusitania", "Maasym", "Macondo",
        ...
        "Samaya", "Sansuna", "Sargas", "Sarin", "Sarir", "Sceptrum", "Scheat", "Schedar",
